      ...
      <div className="relative z-10 flex items-center min-h-[70vh]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-xl mx-auto mb-8 ml-8 text-center">
              <div className="mb-2 whitespace-nowrap">
                We design and refine our own solutions for lasting impact.
              </div>
              <div className="mb-1 whitespace-nowrap ml-2">

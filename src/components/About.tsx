      ...
      <section id="about" className="section-padding relative" ref={sectionRef}>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-blue-50 text-blue-700 ring-1 ring-blue-200">
              <Star className="w-5 h-5 mr-3" /> About AATVAAS GRANGER INTERNATIONALS
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="h-full flex flex-col">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8 font-sans">
                At AATVAAS GRANGER INTERNATIONALS, we are dedicated to driving innovation and delivering exceptional solutions across various industries. Our mission is to empower businesses and individuals with state-of-the-art SaaS, financial, and digital transformation tools.
              </p>
              ...
              <div className="flex gap-8 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div className="font-bold text-gray-900 text-base sm:text-lg font-sans">Experienced Team</div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-lg bg-blue-100 text-blue-700 flex items-center justify-center flex-shrink-0">
                    <Clock className="w-5 h-5" />
                  </div>
                  <div className="font-bold text-gray-900 text-base sm:text-lg font-sans">Fast & Reliable Services</div>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={item} className="flex items-center gap-4 text-gray-700">
                    ...
                    <span className="text-base sm:text-lg font-sans">{item}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg sm:text-xl max-w-3xl mx-auto">
              Empowering businesses with innovative solutions and delivering exceptional results across various industries.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm sm:text-base">Transparency</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">25+</div>
              <div className="text-gray-300 text-sm sm:text-base">Milestones</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">100+</div>
              <div className="text-gray-300 text-sm sm:text-base">Solutions</div>
            </div>
          </div>
        </div>
      </section>
